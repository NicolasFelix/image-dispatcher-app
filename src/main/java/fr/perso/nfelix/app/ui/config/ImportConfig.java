...
public class ImportConfig extends AbstractPropertySheetBean {
  ...
  public static final String[] RENAMEFILE_KEY = { "renameFile", "Renommage syst\u00e9matique des fichiers" };
  /** time offset definition */
  public static final String[] TIMEOFFSET_KEY = { "timeOffset", "Appliquer un décalage sur la date du fichier" };
